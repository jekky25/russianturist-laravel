			...
			<div class="lm_countr">
				<div class="lm_c1">
					<div>
						...
						<li><a href="'/countries/{{$item['countries_eng_name']}}.html" title="{{$item['countries_name']}}">{{$item['countries_name']}}</a></li>
						@endforeach
						</ul>
					</div>
				</div>
				...
				<tr>
					<td>
						<table>
							...
							<td class="vert_pm"></td>
							<td class="vert_pm1"><a href="<?/*=$CODE_INPUT['PATH']*/?>/towns/" title="Города">Города</a></td>
							<td class="vert_pm"></td>
