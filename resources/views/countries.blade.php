...
<a href="{{route('country_name',$item['slug'])}}" alt="{{$item['countries_name']}}" title="{{$item['countries_name']}}" class="prew">
...
<a href="{{route('country_name',$item['slug'])}}" alt="{{$item['countries_name']}}" title="{{$item['countries_name']}}">{{$item['countries_name']}}</a>
</h3>
<p>{!!App\Helpers\Helper::cutText($item['description'], 300)!!}<a href="{{route('country_name',$item['slug'])}}" title="{{$item['countries_name']}}"> »»</a></p>
</div>
	@endforeach
@endif
</div>
