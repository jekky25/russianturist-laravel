...
<a href="{{route('town_name',$item['slug'])}}" alt="{{$item['towns_name']}}" title="{{$item['towns_name']}}" class="prew">
...
<a href="{{route('town_name',$item['slug'])}}" alt="{{$item['towns_name']}}" title="{{$item['towns_name']}}">{{$item['towns_name']}}</a>
</h3>
<p>{!!App\Helpers\Helper::cutText($item['description'], 300)!!}<a href="{{route('town_name',$item['slug'])}}" title="{{$item['towns_name']}}"> »»</a></p>
</div>
	@endforeach
@endif
</div>
